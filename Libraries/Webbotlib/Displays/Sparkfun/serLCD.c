...
/*
 * $Id: serLCD.c,v 1.5 2011/03/07 01:33:42 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: serLCD.c,v $
...
const DISPLAY_CLASS PROGMEM c_SERLCD = MAKE_DISPLAY_CLASS(&init,&cls,null,&gotoXY, null, null, &backlight, &brightness, null, &sendRawByte,&hgraph,&vgraph,null,null,null);
