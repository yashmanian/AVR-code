/*
 * $Id: LCD03.c,v 1.1 2011/03/07 01:32:51 clivewebster Exp $
 * Revision History
 * ================
 * $Log: LCD03.c,v $
...
const DISPLAY_CLASS PROGMEM c_lcd03_i2c = MAKE_DISPLAY_CLASS(&init,&cls,&home,&gotoXY, null, null, &backlight, null, null, &sendRawByte,&hgraph,&vgraph,&customChar, null, null);
