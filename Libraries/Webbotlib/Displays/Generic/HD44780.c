...
/*
 * $Id: HD44780.c,v 1.6 2011/03/07 01:33:41 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: HD44780.c,v $
...
static void init(DISPLAY* display){
	...
	if(device->fourBit){
		...
		cmd |= LCD_FUNCTION_8BIT;					// set 8 bit mode
	}
...
const DISPLAY_CLASS PROGMEM c_HD44780 = MAKE_DISPLAY_CLASS(&init,&cls,&home,&gotoXY, null, null, null, null, null, &sendRawByte,&hgraph,&vgraph,&customChar,null,null);
