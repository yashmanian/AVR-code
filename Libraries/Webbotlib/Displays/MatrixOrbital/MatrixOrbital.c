...
/*
 * $Id: MatrixOrbital.c,v 1.4 2011/03/07 01:33:42 clivewebster Exp $
 *
 * Revision History
 * ================
...
const DISPLAY_CLASS PROGMEM c_MatrixOrbital = MAKE_DISPLAY_CLASS(&init,&cls,null,&gotoXY, &lineWrap, &autoScroll, &backlight, &setBrightness, &setContrast,&sendRawByte, &hgraph, &vgraph,&customChar,null,null);
