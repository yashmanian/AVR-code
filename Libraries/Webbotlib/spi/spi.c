...
// Define the SPI pins for ATtiny85
#undef SS_PORT
#undef SS_DDR
#undef SS_PIN
#undef SPI_SUPPORTED
...
#define SCK_PORT PORTB
#define SCK_DDR  DDRB
#define SCK_PIN  PORTB2

#define MOSI_PORT PORTB
#define MOSI_DDR  DDRB
#define MOSI_PIN  PORTB0

#define MISO_PORT PORTB
#define MISO_DDR  DDRB
#define MISO_PIN  PORTB1
...
const SPI_CLASS PROGMEM c_hw_spi = MAKE_SPI_CLASS(&__spiHWInit, &__spiHWOff,&__spiHWSetClock,&__spiHWSetDataOrder, &__spiHWSetMode,&__spiHWSendByte, null, null,null);
