...
#define SPIUART_SUPPORTED
#if defined(__AVR_ATtiny85__)
# undef SPIUART_SUPPORTED
#endif
...
const SPI_CLASS PROGMEM c_uart_spi = MAKE_SPI_CLASS(&__spiUARTInit, &__spiUARTOff,&__spiUARTSetClock,&__spiUARTSetDataOrder, &__spiUARTSetMode,&__spiUARTSendByte,null,null,null);
