...
REMOTE_ACTUATOR_LIST PROGMEM motors[] = {&motor1,&motor2};
...
typedef struct s_pololu_driver{
	const POLOLU_DS_MOTOR_LIST* const devices;	// The devices
...
class PololuDualSerialMotor : public Actuator{
public:
	PololuDualSerialMotor(POLOLU_DS_MOTOR* c) : Actuator(&c->actuator) {}
};
#endif
