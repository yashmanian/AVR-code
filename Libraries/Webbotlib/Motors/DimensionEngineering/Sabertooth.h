...
typedef struct s_sabertooth_driver{
	const SABERTOOTH_MOTOR_LIST* const motors;// The list of SABERTOOTH_MOTOR
...
class SabertoothMotor : public Actuator{
public:
	SabertoothMotor(SABERTOOTH_MOTOR* c) : Actuator(&c->actuator) {}
};
#endif
