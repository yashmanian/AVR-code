...
typedef struct s_toshiba_tb6612fng_3pin_driver{
	const TOSHIBA_TB6612FNG_3pin_MOTOR_LIST* 	const motors;		// The motors
...
typedef struct s_toshiba_tb6612fng_2pin_driver{
	const TOSHIBA_TB6612FNG_2pin_MOTOR_LIST* 	const motors;		// The motors
	uint8_t 						    num_motors; 		// The total number of motors in the list
...
class tB6612FNG_Motor : public Actuator{
public:
	tB6612FNG_Motor(TOSHIBA_TB6612FNG_3pin_MOTOR* c) : Actuator(&c->actuator) {}
	tB6612FNG_Motor(TOSHIBA_TB6612FNG_2pin_MOTOR* c) : Actuator(&c->actuator) {}
};
#endif
