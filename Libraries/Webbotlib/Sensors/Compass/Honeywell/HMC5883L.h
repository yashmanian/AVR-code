...
public:
	Hmc5883L(HMC5883L* c) : Compass(&c->compass){
		m_hmc = c;
	}
	...
	void refresh1_5Hz(void) const{
		HMC5883L_1_5Hz(m_hmc);
	}
	void refresh3Hz(void) const{
		HMC5883L_3Hz(m_hmc);
	}
	void refresh7_5Hz(void) const{
		HMC5883L_7_5Hz(m_hmc);
	}
	void refresh15Hz(void) const{
		HMC5883L_15Hz(m_hmc);
	}
	void refresh30Hz(void) const{
		HMC5883L_30Hz(m_hmc);
	}
	void refresh75Hz(void) const{
		HMC5883L_75Hz(m_hmc);
	}
