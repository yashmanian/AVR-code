...
typedef struct s_IDG300{
	...
	ADC_CHANNEL  x_pin;
	ADC_CHANNEL  y_pin;
	uint16_t	 x_zero;		// The x adc value at init - used internally
	uint16_t	 y_zero;		// The y adc value at init - used internally
} IDG300;
...
class Idg300 : public Gyro{
public:
	Idg300(IDG300* cstr) : Gyro(&cstr->gyro){}
};
#endif
