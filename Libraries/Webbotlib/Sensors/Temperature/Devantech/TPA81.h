...
class Tpa81 : public Temperature{
public:
	Tpa81(Devantech_TPA81* cstr) : Temperature(&cstr->temperature){
		m_tpa81 = cstr;
	}
	TEMPERATURE_TYPE getSensorCelsius(uint8_t sensor) const{
		return (sensor < 8 ) ? m_tpa81->sensor[sensor] : 0;
	}
private:
	Devantech_TPA81* m_tpa81;
};
#endif
