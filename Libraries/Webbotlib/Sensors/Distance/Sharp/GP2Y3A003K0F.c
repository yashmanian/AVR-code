...
static const SHARP PROGMEM myTable [_ENTS_] = {
		...
		MAKE_SHARP_ENTRY( 19,288,259),
		MAKE_SHARP_ENTRY( 22,246,224),
		MAKE_SHARP_ENTRY( 25,215,198),
		MAKE_SHARP_ENTRY( 29,191,172),
		MAKE_SHARP_ENTRY( 33,166,152),
		MAKE_SHARP_ENTRY( 38,147,132),
		MAKE_SHARP_ENTRY( 43,129,117),
		MAKE_SHARP_ENTRY( 49,115,104),
		MAKE_SHARP_ENTRY( 55,102, 93),
		MAKE_SHARP_ENTRY( 62, 91, 82),
		MAKE_SHARP_ENTRY( 70, 81, 73),
		MAKE_SHARP_ENTRY( 79, 72, 65),
		MAKE_SHARP_ENTRY( 89, 64, 58),
		MAKE_SHARP_ENTRY(100, 58, 52),
		MAKE_SHARP_ENTRY(112, 51, 47),
		MAKE_SHARP_ENTRY(126, 46, 42),
		MAKE_SHARP_ENTRY(132, 41, 40),
...
//	DISTANCE_TYPE cm = 78598.80 * pow(adc, -0.9661);
	...
	DISTANCE_TYPE cm = _gp2_read(device->adcPin, &myTable[0], _ENTS_);
...
const DISTANCE_CLASS PROGMEM c_Sharp_GP2Y3A003K0F = MAKE_DISTANCE_CLASS( \
