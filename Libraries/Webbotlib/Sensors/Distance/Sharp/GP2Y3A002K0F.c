...
static const SHARP PROGMEM myTable [_ENTS_] = {
		MAKE_SHARP_ENTRY( 18, DISTANCE_MAX, DISTANCE_MAX),
		MAKE_SHARP_ENTRY( 22,149,127),
		MAKE_SHARP_ENTRY( 27,121,101),
		MAKE_SHARP_ENTRY( 32, 97, 83),
		MAKE_SHARP_ENTRY( 38, 81, 69),
		MAKE_SHARP_ENTRY( 45, 67, 57),
		MAKE_SHARP_ENTRY( 54, 56, 46),
		MAKE_SHARP_ENTRY( 64, 46, 38),
		MAKE_SHARP_ENTRY( 76, 38, 32),
		MAKE_SHARP_ENTRY( 90, 31, 26),
		MAKE_SHARP_ENTRY(106, 26, 22),
		MAKE_SHARP_ENTRY(117, 22, 20),
...
const DISTANCE_CLASS PROGMEM c_Sharp_GP2Y3A002K0F = MAKE_DISTANCE_CLASS( \
