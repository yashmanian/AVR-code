 ...
 *
 *		Version 2.00 - alpha release 24 Jan 2011 via Webbot site (temporary URL)
 *
 *		Version 2.01 - fixed some uart/buffer issues (plus Version 1.29)
 *
 *		Version 2.02 - 8 March 2011
 *			All the stuff from Version 1.30 plus
 *			Software UART can now use INTx pins as well as ICPx pins
 *
 *		Version 2.03 - 13 April 2011
 *			Fix bug in Sharp GP2 Distance Sensors
 *			Add support for DroneCell for SMS messages
 *
 *		Version 2.04 - 20 April 2011
 ...
 *
 *		Version 2.07 13 August 2011
 *			Added support for two real time clocks - DS3234 and DS1307
 *			Added support for HMC5883L compass (for new Razor board).
 *			Added Dallas 1 Wire support
 *			Added support for the DS18B20 temperature sensor
 ...
 *			The library now compiles in GCC 4.7.0 although the supplied libraries are still compiled via GCC 4.3.3 (WinAVR-20100110)
 *			All projects will need to be regenerated before re-compiling
 *
 *		Version 2.10 21 September 2013
 *			Fixed problem with SRF-08, SRF-02 sensor
 *			Added initial support for ATtiny85 (I2CSlave but not: I2CMaster, SPI, or UART for now
 *			Now need a Version 2.0 or greater of Project Designer and you will need to re-generate your Projects.
 *					this is because the definition of a TIMER has changed.
 *
 *		Version 2.11 6 October 2013
 *			Fix generated code for software uart and tone player
 *			Further improvements made for ATtiny85 support
 *			Must use Version 2.1 of Project Designer and regenerate projects.
 *
 *		ToDo: Document new DroneCell cpp method
 *
 *		Future stuff -
